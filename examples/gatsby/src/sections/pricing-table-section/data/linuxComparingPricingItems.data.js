...
export default [
  {
    ...
    os: {
      name: linuxDistrosEnum.SuperSonicLinuxVps,
...

  {
    ...
    os: {
      name: linuxDistrosEnum.HyperSonicLinuxVps,
      icon: 'pricing-table-section/linux.png',
    },
    action: {
      remoteLink: `${process.env.GATSBY_MIDDLE_CREATE_VM_PAGE}?a=add&pid=178`,
  ...
  },
  {
    ...
    action: {
      remoteLink: `${process.env.GATSBY_MIDDLE_CREATE_VM_PAGE}?a=add&pid=179`,
    },
  },
  {
    title: 'Elite',
    ...
    action: {
      remoteLink: `${process.env.GATSBY_MIDDLE_CREATE_VM_PAGE}?a=add&pid=180`,
    },
  },
  {
    isSelected: true,
