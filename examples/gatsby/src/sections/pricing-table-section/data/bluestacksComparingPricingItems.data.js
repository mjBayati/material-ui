...
export default [
  /**
  {
    ...
    os: {
      name: bluestacksDistrosEnum.SuperSonicBlueStacksVps,
  ...
  */
  {
    ...
    action: {
      remoteLink: `${process.env.GATSBY_MIDDLE_CREATE_VM_PAGE}?a=add&pid=216`,
    },
  },
  /**
  {
    ...
    action: {
      remoteLink: `${process.env.GATSBY_MIDDLE_CREATE_VM_PAGE}?a=add&pid=217`,
    },
  },
   */
  {
    ...
    os: {
      name: bluestacksDistrosEnum.HyperSonicBlueStacksVps,
      icon: 'pricing-table-section/windows.png',
    },
    action: {
      remoteLink: `${process.env.GATSBY_MIDDLE_CREATE_VM_PAGE}?a=add&pid=217`,
  ...
  },
  {
    ...
    action: {
      remoteLink: `${process.env.GATSBY_MIDDLE_CREATE_VM_PAGE}?a=add&pid=230`,
    },
  },
  {
    title: 'Elite',
    ...
    action: {
      remoteLink: `${process.env.GATSBY_MIDDLE_CREATE_VM_PAGE}?a=add&pid=231`,
    },
  },
  /**
  {
