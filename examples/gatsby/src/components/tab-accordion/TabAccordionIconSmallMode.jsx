...
const TabAccordionIconSmallMode = ({ groupedContents }) => {
      ...
      {groupedContents.map((groupedContent) => (
        ...
        >
          <StyledAccordionSummary
            ...
            styleonhoverfortext={{ color: '#2D31A6' }}
          ...
          >
            <StyledAccordionSummaryContent
              ...
              startIcon={
                expanded === groupedContent.id
                  ? groupedContent.activeIcon
                  : groupedContent.icon
              }
              endIcon={
...
TabAccordionIconSmallMode.propTypes = {
...
export default TabAccordionIconSmallMode;
