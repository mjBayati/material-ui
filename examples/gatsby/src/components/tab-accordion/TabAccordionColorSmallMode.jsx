...
const TabAccordionColorSmallMode = ({ groupedContents }) => {
        ...
        >
          <StyledAccordionSummary
            styleonhoverforstarticon={{
              fill: 'white',
              filter:
                'invert(12%) sepia(88%) saturate(4433%) hue-rotate(243deg) brightness(84%) contrast(91%);',
            }}
...
TabAccordionColorSmallMode.propTypes = {
...
export default TabAccordionColorSmallMode;
